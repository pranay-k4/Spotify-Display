...
const char* CLIENT_ID = "MY CLIENT ID FROM THE SPOTIFY DASHBOARD";
const char* CLIENT_SECRET = "MY CLIENT SECRET FROM THE SPOTIFY DASHBOARD";  // I will upload my actual details at time of testing so dw I know I have to replace them
